...
<link rel="stylesheet" type="text/css" href="{{ asset('assets/frontend/css/jslider-theme/jslider-slider.css') }}">
    ...
    <div class="wrapcontent">
            ...
            <div class="right">
                ...
                @if ($entries->isEmpty())
                    <div class="box">
                    <span style="margin-top:60px;">Sorry, no results were found. Please try another search.</span>
                    </div>
                @else
                    ...
                    <div class="box">
                        <div class="left">
                            ...
                            switch ($q) {
                                ...
                                case 'Hotels':
                                    $q_img = 'hotels/';
                                    $route_url = 'hotel-show';
                                    break;
                                case 'Vacation Rentals':
                                    $q_img = 'vacation_rentals/';
                                    $route_url = 'vacation-show';
                                    break;
                                case 'Vehicle Rentals':
                                    $q_img = 'vehicle_rentals/';
                                    $route_url = 'vehicle-show';
                                    break;
                                default:
                                    $q_img = null;
                                    $route_url = 'home';
                            ...
                            <div class="image"><a href="{{ route($route_url, $entry->id) }}"><img style="width:136px; height:auto;" src="{{ asset('assets/img/uploads')}}/{{ $q_img . $entry->photo }}"></a></div>
                            <div class="title"><a href="{{ route($route_url, $entry->id) }}">{{$entry->name}}</a></div>
                            <div class="ratings"><div class="stars three"></div><div class="starsno">5 Star Ratings</div></div>
                            <div class="desc">{{ Str::words(html_entity_decode($entry->short_description), 18);}}<span class="more"><a href="{{ route($route_url, $entry->id) }}"> ..More</a></span></div>
                            <div class="rateinfo">
                                    <div class="urated">
                        ...
                        <div class="right">                           
                                ...
                                <div class="oldprice">
                                    Old Price: 
                                    <span class="cut">${{ $entry->price_per_day +5 }}</span>
                                </div>

                                @elseif ($currency == 'npr')
                                <span class="price dollar">NPR</span> 
                                <?php $npr_cost = ceil($entry->price_per_day * FXRate::where('iso_code', 'USD')->first()->exchange_rate) ?>
                               {{ $npr_cost }}
                                <div class="oldprice">
                                    Old Price: 
                        ...
                        <div class="bottom">
                            ...
                            <div class="right">
                                <a href="{{route('package-tours-order', $entry->id )}}" name="buydeal" class="buydeal" > Book Now </a>
                            </div>
                        <div class="clear"></div>
                        </div>
                    </div>
            ...
            @endif
                    ...
                    <!-- Abacus API Hotel Results -->

                    <style type="text/css">

                     .wrapcontent .right .api:first-child {margin-top:0px !important;}

                    </style>

                    @if(isset($responses->Body->OTA_HotelAvailRS->AvailabilityOptions->AvailabilityOption))

                        @foreach ($responses->Body->OTA_HotelAvailRS->AvailabilityOptions->AvailabilityOption as $option)

                            <div class="box api">
                                <div class="left">

                                    <div class="image"><a href="#"><img style="width:136px; height:auto;" src="{{ asset('assets/img/uploads')}}/default.png"></a></div>
                                    <div class="title"><a href="#">{{ $option->BasicPropertyInfo->attributes()->{'HotelName'} }}</a></div>
                                    <div class="ratings"><div class="stars three"></div><div class="starsno">5 Star Ratings</div></div>
                                    <div class="desc">{{ $option->BasicPropertyInfo->Address->AddressLine }}<span class="more"><a href="#">More</a></span></div>
                                    <div class="rateinfo">
                                            <div class="urated">
                                                <span class="text">User Rating</span>
                                                <div class="bullets three"></div>
                                                <span class="viewby">{{ $option->BasicPropertyInfo->HotelCityCode}}</span>
                                            </div>
                                        </div>
                                    <div class="clear"></div>
                            </div>
                            <div class="right">
                                    ...
                                    <div class="oldprice">
                                        Old Price: 
                                        <span class="cut">${{ 555 +5 }}</span>
                                    </div>

                                    @elseif ($currency == 'npr')
                                    <span class="price dollar">NPR</span> 
                                    <?php $npr_cost = ceil(555 * FXRate::where('iso_code', 'USD')->first()->exchange_rate) ?>
                                   {{ $npr_cost }}
                                    <div class="oldprice">
                                        Old Price: 
                                        <span class="cut">NPR {{ $npr_cost + 500 }}</span>
                            ...
                            <div class="bottom">
                                    ...
                                    <div class="right">
                                        <a href="#" name="buydeal" class="buydeal" > Book Now </a>
                                    </div>
                                    <div class="clear"></div>
                            </div>
                        </div>
                    ...
                    @if(isset($vehicle_responses->Body->VehLocationFinderRS->VehAvailRSCore->VehVendorAvails->VehVendorAvail))

                        @foreach ($vehicle_responses->Body->VehLocationFinderRS->VehAvailRSCore->VehVendorAvails->VehVendorAvail as $option)

                            <div class="box api">
                                <div class="left">

                                    <div class="image"><a href="#"><img style="width:136px; height:auto;" src="{{ asset('assets/img/uploads')}}/default.png"></a></div>
                                    <div class="title"><a href="#">{{ $option->Vendor->attributes()->{'CompanyShortName'} }}</a></div>
                                    <div class="ratings"><div class="stars three"></div><div class="starsno">5 Star Ratings</div></div>
                                    <div class="desc"><span class="more"><a href="#">More</a></span></div>
                                    <div class="rateinfo">
                                            <div class="urated">
                                                <span class="text">User Rating</span>
                                                <div class="bullets three"></div>
