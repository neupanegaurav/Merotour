...
<link rel="stylesheet" type="text/css" href="{{ asset('assets/frontend/css/jslider-theme/jslider-slider.css') }}">
    ...
    <div class="wrapcontent">
            ...
            <div class="right">
                ...
                <div class="box">
                    <div class="left">
                        <div class="image"><a href="{{ route('vacation-show', $entry->id) }}"><img style="width:136px; height:auto;" src="{{ asset('assets/img/uploads/vacation_rentals/' . $entry->photo) }}"></a></div>
                        <div class="title"><a href="{{ route('vacation-show', $entry->id) }}">{{$entry->name}}</a></div>
                        <div class="ratings"><div class="stars three"></div><div class="starsno">5 Star Ratings</div></div>
                        <div class="desc">{{ Str::words(html_entity_decode($entry->short_description), 18);}}<span class="more"><a href="{{ route('vacation-show', $entry->id) }}">More</a></span></div>
                        <div class="rateinfo">
                                <div class="urated">
