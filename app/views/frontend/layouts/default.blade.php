...
<script type="text/javascript" language="javascript" src="{{asset('assets/frontend/js/my_js.js')}}"></script>
<!-- <title>Blackeye Journeys</title> -->
<title>Mero Tour</title>
</head>
...
<div id="popupContact">
<!-- Contact Us Form -->
<form action="#" id="#" method="post" name="form" class="popup_form">
<img id="close" src="{{ asset('assets/frontend/images/closebox.png') }}" onclick ="div_hide()">
<h2 class="popup_h2">Contact Us</h2>
<hr>
<input class="popup_name" id="name" name="name" placeholder="Name" type="text">
<input class="popup_email" id="email" name="email" placeholder="Email" type="text">
<textarea class="popup_msg" id="msg" name="message" placeholder="Message"></textarea>
...
<div style="float:left; width: 150px; padding-left: 80px; padding-top: 10px;"> <p>Call Us: {{ ApplicationSetting::find(7)->phone_number }}</p>
       ...
       <!--  <div class="live_icon">               
        ...
        <div class="live_icon">
                ...
                <div  style="float:right; margin-bottom: 0px;padding-top: 10px;">
                    ...
                    <div style="margin-bottom:5px;">
                        <button class="btn btn-primary" data-toggle="modal" href="#agency_login" style="width:125px;">Agency Login</button>
                        <button class="btn btn-success" data-toggle="modal" href="#agency_signup" style="width:135px;">Agency Signup</button>
                    </div>
                    <div>
        ...
        <!-- <button id="popup" class="popup" onclick="div_show()">Feedback</button> -->
 <a href="{{ route('sctnpay') }}">SCT Npay </a>
    </div><!--end header -->
