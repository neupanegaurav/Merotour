	...
	<input type="hidden" name="_token" value="{{ csrf_token() }}" />
		 ...
		 <div class="control-group {{ $errors->has('uploaded_picture') ? 'error' : '' }}">
				...
				<div class="controls">
                                        ...
                                        <img src="{{asset('assets/img/uploads/slider')}}/{{$entry->big}}" /> <br> <br>
			...
			<div class="control-group {{ $errors->has('country') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="country" id="name" value="{{ Input::old('country', $entry->country) }}" />
				...
				<div class="controls">
                                    ...
                                    <textarea class="span7" name="description" rows="3">{{ Input::old('description', $entry->description) }}</textarea>
