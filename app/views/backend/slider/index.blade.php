...
<div class="row-fluid">
    ...
    <div class="tools">
       ...
       <div class="btn-group">
           <a class="btn btn-primary" id="add-row" href="{{ route('add_slider') }}"><i class="icon-pencil"></i> Add</a>
	...
	<tbody>
		...
		<tr>
			<td>{{ $entry->id }}</td>
			<td><img src="{{ asset('assets/img/uploads/slider/'. $entry->thumbnail)}}" ></td>
                        <td>{{ $entry->country}}</td>
