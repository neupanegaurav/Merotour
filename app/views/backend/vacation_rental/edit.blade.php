                    ...
                    <div class="pull-left" >
                        ...
                        <div class="well">
                            ...
                            <div class="control-group {{ $errors->has('name') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="name" value="{{ Input::old('name', $entry->name) }}" />
                            ...
                            <div class="control-group {{ $errors->has('title') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="title" value="{{ Input::old('title', $entry->title) }}" />
                            ...
                            <div class="control-group {{ $errors->has('added_by') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <select type="text" name="added_by" value="{{ Input::old('added_by', $entry->added_by) }}">
                            ...
                            <div class="control-group {{ $errors->has('vacation_rentals_group') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <select type="text" name="vacation_rentals_group">
                                        <option {{ Input::old('vacation_rentals_group', $entry->vacation_rentals_group) == 'Vacation Rentals' ? 'selected="selected"' : ''  }}>Vacation Rentals</option>            
                                    </select>
                            ...
                            <div class="control-group {{ $errors->has('business_type') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <select type="text" name="business_type" value="{{ Input::old('business_type') }}">
                                        <option {{ Input::old('business_type', $entry->business_type) == 'Vacation Rentals' ? 'selected="selected"' : ''  }}>Vacation Rentals</option>            
                                    </select>
                            ...
                            <div class="control-group {{ $errors->has('category_tree') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <select type="text" name="category_tree" value="{{ Input::old('category_tree') }}">
                                        <option {{ Input::old('category_tree', $entry->category_tree) == 'Hotels' ? 'selected="selected"' : ''  }}>Hotels</option>            
                                    </select>
                        ...
                        <div class="well">
				            ...
				            <div class="control-group {{ $errors->has('uploaded_file') ? 'error' : '' }}">
			                    ...
			                    <div class="controls">
			                         ...
			                         <div style="margin:5px;"> <img style="width:160px; height:160px;" src="{{ asset('assets/img/uploads/vacation_rentals') }}/{{ Input::old('uploaded_file', $entry->photo) }}"></div>
			                ...
			                <div id="append" class="control-group">
                                ...
                                <div class="control-group" id="{{ $multiple_image->image_guid }}">
                                    ...
                                    <div class="controls">
                                        ...
                                        <div style="margin:5px;"> <img src="{{ asset('assets/img/uploads/vacation_rentals') }}/{{ Input::old('uploaded_file', $multiple_image->thumb) }}"></div>
                		...
                		<div class="well">
                            ...
                            <div class="control-group" {{ $errors->has('rent_price') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="rent_price" value="{{ Input::old('rent_price', $entry->rent_price) }}" />
                            ...
                            <div class="control-group" {{ $errors->has('strickthrow_price') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="strickthrow_price" value="{{ Input::old('strickthrow_price', $entry->strickthrow_price) }}" />
                        ...
                        <div class="well">
                            ...
                            <div class="control-group {{ $errors->has('property_name') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="property_name" value="{{ Input::old('property_name', $entry->property_name) }}" />
                            ...
                            <div class="control-group {{ $errors->has('plot_holding_number') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="plot_holding_number" value="{{ Input::old('plot_holding_number', $entry->plot_holding_number) }}" />
                            ...
                            <div class="control-group {{ $errors->has('number_of_stars') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="number_of_stars" value="{{ Input::old('number_of_stars', $entry->number_of_stars) }}" />
                            ...
                            <div class="control-group {{ $errors->has('number_of_accommodates') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="number_of_accommodates" value="{{ Input::old('number_of_accommodates', $entry->number_of_accommodates) }}" />
                            ...
                            <div class="control-group {{ $errors->has('property_size_sq_ft') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="property_size_sq_ft" value="{{ Input::old('property_size_sq_ft', $entry->property_size_sq_ft) }}" />
                            ...
                            <div class="control-group {{ $errors->has('address') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <textarea class="ckeditor" name="address"> {{ Input::old('address', $entry->address) }}</textarea> 
                        ...
                        <div class="well">
                            ...
                            <div class="control-group {{ $errors->has('number_of_rooms') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="number_of_rooms" value="{{ Input::old('number_of_rooms', $entry->number_of_rooms) }}" />
                            ...
                            <div class="control-group {{ $errors->has('number_of_bed_rooms') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="number_of_bed_rooms" value="{{ Input::old('number_of_bed_rooms', $entry->number_of_bed_rooms) }}" />
                            ...
                            <div class="control-group {{ $errors->has('number_of_bath_rooms') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="number_of_bath_rooms" value="{{ Input::old('number_of_bath_rooms', $entry->number_of_bath_rooms) }}" />
                            ...
                            <div class="control-group {{ $errors->has('minimum_stay_nights') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="minimum_stay_nights" value="{{ Input::old('minimum_stay_nights', $entry->minimum_stay_nights) }}" />
                            ...
                            <div class="control-group {{ $errors->has('sleeps') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="sleeps" value="{{ Input::old('sleeps', $entry->sleeps) }}" />
                            ...
                            <div class="control-group {{ $errors->has('gusts') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="gusts" value="{{ Input::old('gusts', $entry->gusts) }}" />
                            ...
                            <div class="control-group {{ $errors->has('garden') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="garden" value="{{ Input::old('garden', $entry->garden) }}" />
                            ...
                            <div class="control-group {{ $errors->has('conservatory') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="conservatory" value="{{ Input::old('conservatory', $entry->conservatory) }}" />
                            ...
                            <div class="control-group {{ $errors->has('garage') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="garage" value="{{ Input::old('garage', $entry->garage) }}" />
                            ...
                            <div class="control-group {{ $errors->has('distance_from_airport') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="distance_from_airport" value="{{ Input::old('distance_from_airport', $entry->distance_from_airport) }}" />
                            ...
                            <div class="control-group {{ $errors->has('distance_from_rail') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="distance_from_rail" value="{{ Input::old('distance_from_rail', $entry->distance_from_rail) }}" />
                            ...
                            <div class="control-group {{ $errors->has('distance_from_market') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="distance_from_market" value="{{ Input::old('distance_from_market', $entry->distance_from_market) }}" />
                            ...
                            <div class="control-group {{ $errors->has('distance_from_city') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="distance_from_city" value="{{ Input::old('distance_from_city', $entry->distance_from_city) }}" />
                            ...
                            <div class="control-group {{ $errors->has('reception') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="reception" value="{{ Input::old('reception', $entry->reception) }}" />
                            ...
                            <div class="control-group {{ $errors->has('kitchen') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="kitchen" value="{{ Input::old('kitchen', $entry->kitchen) }}" />
                        ...
                        <div class="well">
                            ...
                            <div class="control-group {{ $errors->has('brochure_title') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" name="brochure_title" value="{{ Input::old('brochure_title', $entry->brochure_title) }}" />
                            ...
                            <div class="control-group {{ $errors->has('brochure_description') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    <textarea class="span7 ckeditor" name="brochure_description" rows="10">{{ Input::old('brochure_description', $entry->brochure_description) }}</textarea>
                        ...
                        <div class="well">
                            ...
                            <div class="control-group {{ $errors->has('additional_features') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    ...
                                    <textarea class="span7 ckeditor" name="additional_features" rows="10">{{ Input::old('additional_features', $entry->additional_features) }}</textarea>
                            ...
                            <div class="control-group {{ $errors->has('rental_policies') ? 'error' : '' }}">
                                ...
                                <div class="controls">
                                    ...
                                    <textarea class="span7 ckeditor" name="rental_policies" rows="10">{{ Input::old('rental_policies', $entry->rental_policies) }}</textarea>
                    	...
                    	<div class="control-group">
                    		<div class="controls">
                    			...
                    			<button type="submit" class="btn btn-success">Edit Vacation Rental</button>
                    		</div>
                    	</div>
