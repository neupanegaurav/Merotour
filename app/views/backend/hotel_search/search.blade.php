                ...
                @if (!$entries->isEmpty()) 
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        <thead>
                            ...
                            <tr>
                                <td>
                                    <img src="{{asset('assets/img/uploads/hotels')}}/{{ $entry->photo }}" >
                                    ...
                                    <tr>
                                        <td>
                                            <div style="height:200px;">
                                                <img src="{{asset('assets/img/uploads')}}/default.png" >
                                            </div>
                                            
                                            <h3><a href="#" >{{ $option->BasicPropertyInfo->attributes()->{'HotelName'} }}</a></h3>
                                            <p>
                                                Address:: {{ $option->BasicPropertyInfo->Address->AddressLine }} |

                                                <br>

                                                <?php 
                                                    $code = $option->BasicPropertyInfo->attributes()->HotelCode;

                                                    //echo $code; exit();

                                                    $description = new AbacusApiController();

                                                    $description = $description->getHotelDescription($code);

                                                    echo $description->Body->HotelPropertyDescriptionRS->RoomStays->RoomStay->BasicPropertyInfo->VendorMessages->VendorMessage->SubSection[0]->Paragraph->Text[0] . '<br>';
                                                    echo $description->Body->HotelPropertyDescriptionRS->RoomStays->RoomStay->BasicPropertyInfo->VendorMessages->VendorMessage->SubSection[0]->Paragraph->Text[1] . '<br>';
                                                    echo $description->Body->HotelPropertyDescriptionRS->RoomStays->RoomStay->BasicPropertyInfo->VendorMessages->VendorMessage->SubSection[0]->Paragraph->Text[2] . '<br>';
                                                ?>
                                                <br> 
