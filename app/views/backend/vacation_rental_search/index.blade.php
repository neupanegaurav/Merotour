                                ...
                                <form action="{{URL::route('searchbox3')}}" method="post">
                                    ...
                                    <div class="location clearfix">
                                        ...
                                        <div class="pull-left">
                                            ...
                                            <label style="background:none;">Features</label>
 ...
 <script type="text/javascript">
     $(document).ready(function() {
        ...
        $("#domestic").on('click', function() {
            ...
            $("#h4").text('Domestic Vacation Rental Search');
        ...
        $("#international").on('click', function() {
            ...
            $("#h4").text('International Vacation Rental Search');
