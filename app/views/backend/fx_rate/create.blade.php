...
<form class="form-horizontal" method="post" action="" autocomplete="off">
	...
	<input type="hidden" name="_token" value="{{ csrf_token() }}" />
			...
			<div class="control-group {{ $errors->has('currency') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="currency" currency="currency" id="currency" value="{{ Input::old('currency') }}" />
			...
			<div class="control-group {{ $errors->has('iso_code') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="iso_code" id="iso_code" value="{{ Input::old('iso_code') }}" />
			...
			<div class="control-group {{ $errors->has('symbol') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="symbol" id="symbol" value="{{ Input::old('symbol') }}" />
			...
			<div class="control-group {{ $errors->has('exchange_rate') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="exchange_rate" id="exchange_rate" value="{{ Input::old('exchange_rate') }}" />
	...
	<div class="control-group">
		<div class="controls">
			...
			<button type="submit" class="btn btn-success">Create FXRate</button>
		</div>
	</div>
</form>
