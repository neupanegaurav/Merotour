    ...
    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
        ...
        <div class="well">
            ...
            <div class="control-group {{ $errors->has('country') ? 'error' : '' }}">
                ...
                <div class="controls">
                    ...
                    @foreach($countries as $country)
                        <option value="{{ $country->value }}" {{ Input::old('country', $entry->country) == $country->id ? 'selected="selected"' : ''  }}   >{{ $country->value }}</option>
                    @endforeach
            ...
            <div class="control-group {{ $errors->has('city') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <input type="text" name="city" value="{{ Input::old('city', $entry->city) }}" />
            ...
            <div class="control-group {{ $errors->has('latitude') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <input type="text" name="latitude" value="{{ Input::old('latitude', $entry->latitude) }}" />
            ...
            <div class="control-group {{ $errors->has('longitude') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <input type="text" name="longitude" value="{{ Input::old('longitude', $entry->longitude) }}" />
            ...
            <div class="control-group {{ $errors->has('altitude') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <input type="text" name="altitude" value="{{ Input::old('altitude', $entry->altitude) }}" />
