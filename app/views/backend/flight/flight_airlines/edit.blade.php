...
<form class="form-horizontal" method="post" action="" autocomplete="off" enctype="multipart/form-data">
	...
	<input type="hidden" name="_token" value="{{ csrf_token() }}" />
			...
			<div class="control-group {{ $errors->has('airlines_name') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="airlines_name" value="{{ Input::old('airlines_name', $entry->airlines_name) }}" />
            ...
            <div class="control-group {{ $errors->has('airlines_hub') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="airlines_hub" id="airlines_hub" value="{{ Input::old('airlines_hub', $entry->airlines_hub) }}" />
            ...
            <div class="control-group {{ $errors->has('airlines_hub_city') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="airlines_hub_city" id="airlines_hub_city" value="{{ Input::old('airlines_hub_city', $entry->airlines_hub_city) }}" />
			...
			<div class="control-group {{ $errors->has('primary_image') ? 'error' : '' }}">
				...
				<div class="controls">
					<img src="{{ asset('assets/img/airlines/' . $entry->airlines_logo) }}"> 
					<br>
          Upload new logo: <input type="file" name="primary_image" >
            ...
            <div class="control-group" {{ $errors->has('airlines_shortcode') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="airlines_shortcode" id="airlines_shortcode" value="{{ Input::old('airlines_shortcode', $entry->airlines_shortcode)}}" />
			...
			<div class="control-group" {{ $errors->has('airlines_code') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="airlines_code" id="airlines_code" value="{{ Input::old('airlines_code', $entry->airlines_code)}}" />
            ...
            <div class="control-group" {{ $errors->has('airlines_short_desc') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="airlines_short_desc" id="airlines_short_desc" value="{{ Input::old('airlines_short_desc', $entry->airlines_short_desc) }}" />
            ...
            <div class="control-group" {{ $errors->has('airlines_date') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="airlines_date" id="airlines_date" value="{{ Input::old('airlines_date', $entry->airlines_date ) }}" />
	...
	<div class="control-group">
		<div class="controls">
			<a class="btn btn-link" href="{{ route('flight_airlines') }}">Back</a>

			<button type="reset" class="btn">Reset</button>

			<button type="submit" class="btn btn-success">Edit Airline</button>
		</div>
	</div>
</form>
