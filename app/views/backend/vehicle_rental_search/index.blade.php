...
<div class="row-fluid">
	...
	<div id="tabs-3" class="tab clearfix" style="width:450px;" >
                            <div class="detail">
                                <form action="{{URL::route('searchbox4')}}" method="post">
                                    ...
                                    <div class="location clearfix">
                                        ...
                                        <div class="pull-left">
                                            ...
                                            <label style="background:none;">Select Vehicle</label>
                                            <select name="cost_package" id="cost_package" size="1" class="package_change ui-widget-content ui-corner-all">
                                            <option value="1" label="Chrysler 300C Wedding Car Hire">Chrysler 300C Wedding Car Hire</option>
                                            <option value="2" label="Beautiful Beauford Wedding Cars">Beautiful Beauford Wedding Cars</option>
                                            <option value="3" label="Pickup Truck">Pickup Truck</option>
                                            <option value="4" label="Cargo Van">Cargo Van</option>
                                            <option value="5" label="Aston Martin V8 Roadster N420">Aston Martin V8 Roadster N420</option>
                                            <option value="6" label="ASTON MARTIN V8 VANTAGE">ASTON MARTIN V8 VANTAGE</option>
                                            <option value="7" label="Mercedes C63 Amg Saloon">Mercedes C63 Amg Saloon</option>
                                            <option value="8" label="Range Rover Sport">Range Rover Sport</option>
                                            <option value="9" label="Limogin">Limogin</option>
                                            </select>
 ...
 <script type="text/javascript">
     $(document).ready(function() {
        ...
        $("#domestic").on('click', function() {
            ...
            $("#h4").text('Domestic Vehicle Rental Search');
        ...
        $("#international").on('click', function() {
            ...
            $("#h4").text('International Vehicle Rental Search');
