...
<div class="row-fluid">
    ...
    <div class="tools">
        ...
        <div class="btn-group">      
            <a class="btn btn-primary" id="add-row" href="{{ route('create/agent') }}"><i class="icon-pencil"></i> Add</a>   
        </div>
    </div>
    <!-- END TABLE TOOLS -->
            ...
            <tbody>
            	...
            	@foreach ($users as $user)
            			...
            			<tr>
            				...
            				<td span="3">
            					<a href="{{ route('edit/agent', $user->id) }}" class="btn btn-mini">@lang('button.edit')</a>
                    
            					@if ( ! is_null($user->deleted_at))
            					<a href="{{ route('restore/user', $user->id) }}" class="btn btn-mini btn-warning">@lang('button.restore')</a>
            					@else
            					@if (Sentry::getId() !== $user->id)
            					<a href="{{ route('delete/agent', $user->id) }}" class="btn btn-mini btn-danger">@lang('button.delete')</a>
            					@else
