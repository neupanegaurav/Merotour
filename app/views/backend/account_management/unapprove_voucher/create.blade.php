			...
			<ul class="breadcrumb">
			    <li>
			        ...
			        Account Management
			            ...
			            <li><a href="{{ route('general-voucher') }}">Unapproved Voucher</a>
			                      <span class="icon-angle-right"></span>
			                          
			                            </li>
			            

			                        <li>Add Unapproved Voucher
...
<form class="form-horizontal" method="post" action="" autocomplete="off">
	...
	<input type="hidden" name="_token" value="{{ csrf_token() }}" />
				...
				<div class="control-group {{ $errors->has('amount') ? 'error' : '' }}">
					...
					<div class="controls">
						<input type="text" name="amount" value="{{ Input::old('amount') }}" />
				...
				<div class="control-group {{ $errors->has('date') ? 'error' : '' }}">
					...
					<div class="controls">
						<input type="text" name="date" id="datepick1" value="{{ Input::old('date') }}" />
				...
				<div class="control-group {{ $errors->has('transaction_id') ? 'error' : '' }}">
					...
					<div class="controls">
						<input type="text" name="transaction_id"  value="{{ Input::old('transaction_id') }}" />
				...
				<div class="control-group {{ $errors->has('category_name') ? 'error' : '' }}">
					...
					<div class="controls">
						<input type="text" name="category_name"  value="{{ Input::old('category_name') }}" />
				...
				<div class="control-group {{ $errors->has('package_name') ? 'error' : '' }}">
					...
					<div class="controls">
						<input type="text" name="package_name"  value="{{ Input::old('package_name') }}" />
				...
				<div class="control-group {{ $errors->has('package_id') ? 'error' : '' }}">
					...
					<div class="controls">
						<input type="text" name="package_id"  value="{{ Input::old('package_id') }}" />
				...
				<div class="control-group {{ $errors->has('remarks') ? 'error' : '' }}">
					...
					<div class="controls">
					<textarea name="remarks">{{ Input::old('remarks') }}</textarea>
	...
	<div class="control-group">
		<div class="controls">
			...
			<button type="submit" class="btn btn-success">Add Unapproved Voucher</button>
		</div>
	</div>
