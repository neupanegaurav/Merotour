...
@section('title')
Credit Limit Management(Branch Office) :: @parent
@stop
...
<div class="row-fluid">
        <div class="span12">
            <h3 class="page-title">
                Credit Limit Management(Branch Office)
            </h3>
            <!-- BEGIN BREADCRUMBS -->
			<ul class="breadcrumb">
                <li>
                    ...
                    Account Management
                            <span class="icon-angle-right"></span>
                                    ...
                                    <li>Credit Limit Management(Branch Office)
    ...
    <table class="table table-bordered table-striped table-hover">
        <thead>
            <tr>             
                ...
                <th class="span2">Branch Office Name</th>
