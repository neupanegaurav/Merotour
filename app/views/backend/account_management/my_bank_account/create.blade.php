			...
			<input type="hidden" name="_token" value="{{ csrf_token() }}" />
		        ...
		        <div class="pull-left" >
					...
					<div class="control-group {{ $errors->has('bank_name') ? 'error' : '' }}">
						...
						<div class="controls">
							<input type="text" name="bank_name" id="bank_name" value="{{ Input::old('bank_name') }}" />
					...
					<div class="control-group {{ $errors->has('bank_branch') ? 'error' : '' }}">
						...
						<div class="controls">
							<input type="text" name="bank_branch" id="bank_branch" value="{{ Input::old('bank_branch') }}" />
		            ...
		            <div class="control-group {{ $errors->has('account_name') ? 'error' : '' }}">
						...
						<div class="controls">
							<input type="text" name="account_name" id="account_name" value="{{ Input::old('account_name') }}" />
		            ...
		            <div class="control-group" {{ $errors->has('account_number') ? 'error' : '' }}">
						...
						<div class="controls">
							<input type="text" name="account_number" id="account_number" value="{{ Input::old('account_number')}}" />
		            ...
		            <div class="control-group" {{ $errors->has('swift_code') ? 'error' : '' }}">
						...
						<div class="controls">
							<input type="text" name="swift_code" id="swift_code" value="{{ Input::old('swift_code') }}" />
					...
					<div class="control-group" {{ $errors->has('company_name') ? 'error' : '' }}">
						...
						<div class="controls">
							<input type="text" name="company_name" id="company_name" value="{{ Input::old('company_name') }}" />
