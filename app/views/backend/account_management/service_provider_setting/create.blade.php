	...
	<input type="hidden" name="_token" value="{{ csrf_token() }}" />
        ...
        <div class="pull-left" >
			...
			<div class="control-group {{ $errors->has('dr_cr') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="dr_cr" id="dr_cr" value="{{ Input::old('dr_cr') }}" />
            ...
            <div class="control-group" {{ $errors->has('narration') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="narration" id="narration" value="{{ Input::old('narration')}}" />
            ...
            <div class="control-group" {{ $errors->has('debit') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="debit" id="debit" value="{{ Input::old('debit') }}" />
			...
			<div class="control-group" {{ $errors->has('credit') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="credit" id="credit" value="{{ Input::old('credit') }}" />
