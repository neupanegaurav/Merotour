...
<form class="form-horizontal" method="post" action="" autocomplete="off">
	...
	<input type="hidden" name="_token" value="{{ csrf_token() }}" />
        ...
        <div class="pull-left" >
			...
			<div class="control-group {{ $errors->has('product') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="product" id="product" value="{{ Input::old('product', $entry->product) }}" />
            ...
            <div class="control-group {{ $errors->has('account_group') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="account_group" id="account_group" value="{{ Input::old('account_group', $entry->account_group) }}" />
				...
				<div class="controls">
					<input type="text" name="account_sub_group" id="account_sub_group" value="{{ Input::old('account_sub_group', $entry->account_sub_group)}}" />
            ...
            <div class="control-group" {{ $errors->has('account_type') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="account_type" id="account_type" value="{{ Input::old('account_type', $entry->account_type) }}" />
			...
			<div class="control-group" {{ $errors->has('ledger') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="ledger" id="ledger" value="{{ Input::old('ledger', $entry->ledger) }}" />
	...
	<div class="control-group">
		<div class="controls">
			...
			<button type="submit" class="btn btn-success">Edit Ledger</button>
		</div>
	</div>
