        ...
        <tbody>
            ...
            @foreach($entries as $entry)
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route('edit/general-voucher', $entry->id)}}" class="btn btn-mini">Edit</a>    
                        <a href="{{route('delete/general-voucher', $entry->id)}}" class="btn btn-mini btn-danger">@lang('button.delete')</a>    
                    </td>
                </tr>
