	...
	<div class="tab-content">
		...
		<div class="tab-pane active" id="tab-general">
			...
			<div class="control-group {{ $errors->has('content') ? 'error' : '' }}">
				...
				<div class="controls">
					<textarea class="span10 ckeditor" name="content" id="content" value="content" rows="10">{{ Input::old('content') }}</textarea>
		...
		<div class="tab-pane" id="tab-meta-data">
			...
			<div class="control-group {{ $errors->has('meta-title') ? 'error' : '' }}">
				...
				<div class="controls">
					<input class="span6" type="text" name="meta-title" id="meta-title" value="{{ Input::old('meta-title') }}" />
			...
			<div class="control-group {{ $errors->has('meta-description') ? 'error' : '' }}">
				...
				<div class="controls">
					<input class="span6" type="text" name="meta-description" id="meta-description" value="{{ Input::old('meta-description') }}" />
			...
			<div class="control-group {{ $errors->has('meta-keywords') ? 'error' : '' }}">
				...
				<div class="controls">
					<input class="span6" type="text" name="meta-keywords" id="meta-keywords" value="{{ Input::old('meta-keywords') }}" />
