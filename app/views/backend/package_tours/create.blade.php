	...
	<input type="hidden" name="_token" value="{{ csrf_token() }}" />
        ...
        <legend>General Information</legend>
            ...
            <div class="control-group {{ $errors->has('organized_by') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <input type="text" name="organized_by" id="organized_by" value="{{ Input::old('organized_by') }}" />
            ...
            <div class="control-group {{ $errors->has('package_group') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <select type="text" name="package_group" value="{{ Input::old('package_group') }}">
            ...
            <div class="control-group {{ $errors->has('type') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <select type="text" name="type" id="type" value="{{ Input::old('type') }}">
                    </select>
            ...
            <div class="control-group {{ $errors->has('category') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <select type="text" name="category" value="{{ Input::old('category') }}">
                    </select>
        ...
        <div class="well">
            ...
            <div class="control-group {{ $errors->has('infant_price') ? 'error' : '' }}">
                <label class="control-label" >Infant Price</label>
                <div class="controls">
            ...
            <div class="control-group {{ $errors->has('payment_description') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <textarea name="payment_description"> {{ Input::old('payment_description') }}</textarea> 
        ...
        <div class="well">
            ...
            <div class="control-group {{ $errors->has('number_of_rating') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <input type="text" name="number_of_rating" value="{{ Input::old('number_of_rating') }}" />
            ...
            <div class="control-group {{ $errors->has('tour_code') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <input type="text" name="tour_code" value="{{ Input::old('tour_code') }}" />
            ...
            <div class="control-group {{ $errors->has('nights') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <input type="text" name="nights" value="{{ Input::old('nights') }}" />
            ...
            <div class="control-group {{ $errors->has('days') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <input type="text" name="days" value="{{ Input::old('days') }}" />
            ...
            <div class="control-group {{ $errors->has('transportation') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <textarea name="transportation"> {{ Input::old('transportation') }}</textarea> 
        ...
        <div class="well">
            ...
            <div class="control-group {{ $errors->has('start_city') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <input type="text" name="start_city" value="{{ Input::old('start_city') }}" />
            ...
            <div class="control-group {{ $errors->has('end_city') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <input type="text" name="end_city" value="{{ Input::old('end_city') }}" />
            ...
            <div class="control-group {{ $errors->has('visiting_cities') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <input type="text" name="visiting_cities" value="{{ Input::old('visiting_cities') }}" />
            ...
            <div class="control-group {{ $errors->has('schedules_operating') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <input type="text" name="schedules_operating" value="{{ Input::old('schedules_operating') }}" />
            ...
            <div class="control-group {{ $errors->has('sightseeing') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <input type="text" name="sightseeing" value="{{ Input::old('sightseeing') }}" />
            ...
            <div class="control-group {{ $errors->has('no_of_accommodates') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <input type="text" name="no_of_accommodates" value="{{ Input::old('no_of_accommodates') }}" />
            ...
            <div class="control-group {{ $errors->has('multilingual_guide_tape') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <input type="text" name="multilingual_guide_tape" value="{{ Input::old('multilingual_guide_tape') }}" />
            ...
            <div class="control-group {{ $errors->has('pick_up_service') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <input type="text" name="pick_up_service" value="{{ Input::old('pick_up_service') }}" />
            ...
            <div class="control-group {{ $errors->has('supplementary_room_addon_facilities') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <input type="text" name="supplementary_room_addon_facilities" value="{{ Input::old('supplementary_room_addon_facilities') }}" />
            ...
            <div class="control-group {{ $errors->has('drop_off_service') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <input type="text" name="drop_off_service" value="{{ Input::old('drop_off_service') }}" />
        ...
        <div class="well">
            ...
            <div class="control-group {{ $errors->has('itinerary_title') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <input type="text" name="itinerary_title" value="{{ Input::old('itinerary_title') }}" />
            ...
            <div class="control-group {{ $errors->has('detailed_itinerary') ? 'error' : '' }}">
                ...
                <div class="controls">
                    <textarea class="ckeditor" name="detailed_itinerary"> {{ Input::old('detailed_itinerary') }}</textarea> 
        ...
        <div class="well">
            ...
            <div class="control-group {{ $errors->has('tour_highlights') ? 'error' : '' }}">
                ...
                <div class="controls">
                    ...
                    <textarea class="span7 ckeditor" name="tour_highlights" rows="10">{{ Input::old('tour_highlights') }}</textarea>
            ...
            <div class="control-group {{ $errors->has('tour_policies') ? 'error' : '' }}">
                ...
                <div class="controls">
                    ...
                    <textarea class="span7 ckeditor" name="tour_policies" rows="10">{{ Input::old('tour_policies') }}</textarea>
