...
<div class="row-fluid">
    ...
    <div class="body"> 
                ...
                <table class="table table-bordered table-striped table-hover">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th class="span2">Contact Number</th>
                            <th class="span2">Contact Email</th>              
                        </tr>
                    </thead>
                    <tbody>
                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    @foreach($passengers as $passenger)
                        <tr>
                            ...
                            <td> {{ $passenger->tax }} </td>
                            <td> {{ $total += $passenger->fare + $passenger->surcharge + $passenger->tax }} </td>
                        </tr>
                                                
                        @endforeach
                         <tr>
                            <td colspan="4"><p class="pull-right">Total</p></td>
                            <td> {{ $total }} </td> 
            ...
            <div class="control-group">
                <div class="controls">
                    <a class="btn btn-link pull-left" href="{{ route('reserved-tickets') }}">Back to Reserved Tickets List</a>
                    
                     <form class="form-horizontal pull-left" method="post" action="" autocomplete="off">
                        <!-- CSRF Token -->
