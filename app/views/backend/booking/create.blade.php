    ...
    <div class="body"> 
        ...
        <form class="form-horizontal" method="post" action="" autocomplete="off">
                            ...
                            <select id="users_list" name="user">
                                ...
                                @foreach($users_list as $user)
                                 ...
                                 ?>
                                    ...
                                    <option value="{{ $user->id }}" balance="{{ isset($funds) ? $funds->balance : '0'  }}" userrole="{{ !empty($groups[0]->name) ? $groups[0]->name : 'Users' }}" address="{{ $user->address }}" mobile="{{ $user->mobile }}">
                ...
                <table class="table table-bordered table-striped table-hover">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th class="span2">Flight Date</th>
                            <th class="span2">Flight Time</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="control-group {{ $errors->has('flight_date') ? 'error' : '' }}">
                                    <div class="controls" style="margin:0px;">
                                    <input id="datepick2" style="width:100px;" type="text" name="flight_date" value=" {{Input::old('flight_date')}}" />
                            ...
                            <td>
                                <div class="control-group {{ $errors->has('flight_time') ? 'error' : '' }}">
                                    <div class="controls" style="margin:0px;">
                                    <input id="f" style="width:100px;" type="text" name="flight_time" value="{{Input::old('flight_time')}}" />
                                    {{ $errors->first('flight_time', '<span class="help-inline">:message</span>') }}
                                    </div>
                                </div>
                            </td> 
                            ...
                            <td>
                                <div class="control-group {{ $errors->has('pnr_no') ? 'error' : '' }}">
                                    <div class="controls" style="margin:0px;">
                                    <input id="f" style="width:100px;" type="text" name="pnr_no" value="{{Input::old('pnr_no')}}" />
                                    <!--
            ...
            <div class="control-group">
                <div class="controls">
                    <a class="btn btn-link" href="{{ route('issued-tickets') }}">Back</a>
