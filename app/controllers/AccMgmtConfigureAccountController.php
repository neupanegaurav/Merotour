...
class AccMgmtConfigureAccountController extends BaseController {
    
   
    public function getIndex() {
        
        $entry = ConfigureAccount::first();
        
        return View::make('backend.account_management.configure_account.index', compact('entry'));
    ...
    public function getCreate()
	{
		...
		// Show the page
		return View::make('backend.account_management.configure_account.create');
	}
