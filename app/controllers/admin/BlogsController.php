...
class BlogsController extends AdminController {
	...
	public function getEdit($postId = null)
	{
		...
		if (is_null($post = Post::find($postId)))
		{
			...
			return Redirect::to('admin/blogs')->with('error', Lang::get('admin/news/message.does_not_exist'));
		}
	...
	public function postEdit($postId = null)
	{
		...
		{
			// Redirect to the new blog post page
			return Redirect::to("admin/news/$postId/edit")->with('success', 'News edit success');
		}

		// Redirect to the blogs post management page
		return Redirect::to("admin/news/$postId/edit")->with('error', 'News edit error');
	}
	...
	public function getDelete($postId)
	{
		...
		{
			// Redirect to the blogs management page
			return Redirect::to('admin/blogs')->with('error', Lang::get('admin/news/message.not_found'));
		}
		...
		return Redirect::to('admin/blogs')->with('success', Lang::get('admin/news/message.delete.success'));
	}
