...
class PaperFareController extends BaseController {
    ...
    public function getIndex() {
        ...
        return View::make('backend.paper_fare.index', compact('entries'));
    ...
    public function getCreate()
	{
		...
		// Show the page
		return View::make('backend.paper_fare.create');
	}
    ...
    public function getEdit($id)
	{
		...
		// Show the page
		return View::make('backend.paper_fare.edit', compact('entry'));
	}
