...
UIElementsGeneral = (function($) {
  ...
  var config, handleAvgrundExample, handleBigChatExample, handleDateRangePickerExample, handlePopoversTooltips, handlePulsateExamples, handleRatingSystemExamples, handleRegularGritterExample, handleScrollFeedsList, handleStickyGritterExample, init, isRTLVersion, removeAllGritters;
  config = {
    urlAvatar: 'none'
  };
  /**/
