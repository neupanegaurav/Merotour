...
class Application extends Container implements HttpKernelInterface, ResponsePreparerInterface
{
    ...
    {
        return 'D:\\UniServerZ\\www\\blackeyetravels\\vendor\\laravel\\framework\\src\\Illuminate\\Foundation' . '/start.php';
    }
...
class PrettyPageHandler extends Handler
{
    ...
    public function handle()
    {
        ...
        if (!($resources = $this->getResourcesPath())) {
            $resources = 'D:\\UniServerZ\\www\\blackeyetravels\\vendor\\filp\\whoops\\src\\Whoops\\Handler' . '/../Resources';
        }
